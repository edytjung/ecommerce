        ...
        <div id="navbar-collapse-with-animation" class="hidden overflow-hidden transition-all duration-300 hs-collapse basis-full grow md:block">
          <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
            <div class="flex flex-col mt-5 divide-y divide-gray-200 gap-x-0 divide-dashed md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
              ...
              <a wire:navigate class="py-3 {{ request()->is('/') ? ' text-blue-600 dark:text-blue-500' : 'text-gray-500 over:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500' }} font-medium md:py-6  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/" aria-current="page">Home</a>

              <a wire:navigate class="py-3 {{ request()->is('categories') ? ' text-blue-600 dark:text-blue-500' : 'text-gray-500 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500' }} font-medium  md:py-6  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/categories">
                Categories
              </a>

              <a wire:navigate class="py-3 {{ request()->is('products') ? ' text-blue-600 dark:text-blue-500' : 'text-gray-500 over:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500' }} font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products">
                Products
              </a>

              <a wire:navigate class="flex {{ request()->is('cart') ? ' text-blue-600 dark:text-blue-500' : 'text-gray-500 over:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500' }} items-center py-3 font-medium dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/cart">
