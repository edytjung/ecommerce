            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range"
                                ...
                                max="10000000" value="{{$price_range}}" step="5000" wire:model.live='price_range'>
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                                    {{ Number::currency(1000, 'IDR')}}
                                </span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                                    {{ Number::currency(10000000, 'IDR')}}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full px-3 lg:w-3/4">
                    ...
                    <div class="flex flex-wrap items-center ">
                        ...
                        <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:ket='{{ $product->id }}'>
