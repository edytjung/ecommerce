            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                <tr wire:key='{{ $item['product_id']}}'>
                  ...
                  <td class="py-4">
                    <div class="flex items-center">
                      <button class="px-4 py-2 mr-2 border rounded-md" wire:click='decreaseQty({{ $item['product_id']}})'>-</button>
                      <span class="w-8 text-center">{{ $item['quantity'] }}</span>
                      <button class="px-4 py-2 ml-2 border rounded-md" wire:click='increaseQty({{ $item['product_id']}})'>+</button>
                    </div>
                  </td>
                ...
                @empty
                <tr>
                    <td colspan="5" class="py-4 text-4xl font-semibold text-center test-slate-500">No Items available in cart!</td>
                </tr>
                @endforelse
                <!-- More product rows -->
              </tbody>
